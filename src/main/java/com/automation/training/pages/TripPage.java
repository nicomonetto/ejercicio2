...
public class TripPage extends BasePage {
	...
	public void VerificarSalida() {
		WebDriverWait wait = new WebDriverWait(driver, 10);	
		WebElement salida = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/section[1]/div/div[1]")));	
	...
	public void VerificarVuelta() {
		WebDriverWait wait = new WebDriverWait(driver, 10);	
		WebElement vuelta = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/section[1]/div/div[2]/div/div")));	
